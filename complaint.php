<?php
	...
	if(empty($_SESSION['username']))
		...
		if(isset($_POST['register'])) {
			...
			$rectified = $_POST['rectified'];
			
			try {
					$stmt = $connect->prepare('INSERT INTO cmps (name,cmp,username,fullname,rectified) VALUES (:name, :cmp,:username,:fullname,:rectified)');
					$stmt->execute(array(
						':name' => $name,
						':cmp' => $cmp,
						':username' => $username,
		...
		<div class="row">
			...
			<h2>Complaints</h2>
				<form action="" method="post">
			   	...
			   	<div class="col-6">
			 		 <div class="form-group">
					    <label for="rectified">rectified/not rectified</label>
					    <input type="text" class="form-control" id="rectified" placeholder="Text" name="rectified" required>
					  </div>
			 	</div>
